...
import org.testfun.runner.inject.InjectionUtils;
...
public class InjectionUtilsTest {
    ...
    public void getFieldInterfaceFailed() throws NoSuchFieldException {
        thrown.expectMessage("field 'str' declared in class org.testfun.InjectionUtilsTest$ClassA isn't an interface");
    ...
    public void assignObjectToFieldFailed() throws NoSuchFieldException {
        thrown.expectMessage("Failed injecting to field 'in' declared in class org.testfun.InjectionUtilsTest$ClassA");
    ...
    public void readObjectFromFieldFailed() throws NoSuchFieldException {
        ...
        thrown.expectMessage("Failed to read from field 'child' declared in class org.testfun.InjectionUtilsTest$ClassB (superclass of class org.testfun.InjectionUtilsTest$ClassA)");
    ...
    public void getFieldDescription() throws NoSuchFieldException {
        assertEquals(
                "field 'child' declared in class org.testfun.InjectionUtilsTest$ClassB",
                InjectionUtils.getFieldDescription(ClassB.class.getDeclaredField("child"), new ClassB()));
        assertEquals(
                "field 'str' declared in class org.testfun.InjectionUtilsTest$ClassA (superclass of class org.testfun.InjectionUtilsTest$ClassB)",
